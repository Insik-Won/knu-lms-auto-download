#!/usr/bin/env bash
curl -L --referer ";auto" -v -X GET --cookie cookie.txt --cookie-jar cookie.txt https://lms.knu.ac.kr/ilos/lo/logout.acl \
-H "Connection: close" \
...
-H "Referer: https://lms.knu.ac.kr/ilos/main/main_form.acl" \
